"""
Django settings for FreightM8 project.
...
SECRET_KEY = env("SECRET_KEY", default="ZFPdQmUCcHtkrdZvoobiNETpdVgTQrwhkOguqqaS")
...
ROOT_URLCONF = "freightm8.urls"


SIMPLE_JWT = {
    # It will work instead of the default serializer(TokenObtainPairSerializer).
    "TOKEN_OBTAIN_SERIALIZER": "freightm8.serializers.MyTokenObtainPairSerializer",
    # ...
}
...
WSGI_APPLICATION = "freightm8.wsgi.application"
...
if "DATABASE_URL" in env:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": env("DJANGO_DATABASE_NAME", default="freightm8"),
...
LANGUAGE_CODE = "en-us"
LANGUAGE_COOKIE_NAME = "freightm8_language"
...
EMAIL_SUBJECT_PREFIX = "[FreightM8] "
...
ASGI_APPLICATION = "freightm8.asgi.application"
CHANNEL_LAYERS = {
    "default": {
...
WAGTAIL_SITE_NAME = "FreightM8 Content"
...
LOGGING = {
    ...
    "loggers": {
        ...
        "freightm8": {
            "handlers": ["console"],
            "level": env("FREIGHTM8_LOG_LEVEL", default="INFO"),
        },
    },
}
